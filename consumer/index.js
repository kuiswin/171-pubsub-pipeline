...
// Cloud Run Push サブスクリプション受信用 Webhook エンドポイントエイリアス (/translate へ転送)
app.post('/pubsub-push', (req, res, next) => {
  req.url = '/translate';
...
if (isLocal) {
  ...
  console.log('[Consumer] Running in PRODUCTION mode (Push subscription endpoint /pubsub-push active).');
}
